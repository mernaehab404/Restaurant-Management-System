...
public class admin extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            {
              int i;
                int id = Integer.parseInt(this.emp_id4.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            {
        int id = Integer.parseInt(this.meal_id1.getText());
        int quantity = Integer.parseInt(this.meal_quantity1.getText());
        int price = Integer.parseInt(this.meal_price1.getText());
            int i;
            for (i=0;i<database.meals_database.get_meals().size();i++)
            {
                if (id==database.meals_database.get_meals().get(i).getMeal_id())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            {
              int id = Integer.parseInt(this.emp_id1.getText());
            for (i=0;i<database.employee_database.get_employee().size();i++)
            {
                if (id==database.employee_database.get_employee().get(i).getId())
                {
