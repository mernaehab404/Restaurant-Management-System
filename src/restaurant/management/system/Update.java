...
public class Update extends javax.swing.JFrame {
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        OF.deleteCustomerOrder( Integer.parseInt(id.getText()) );
        
        int r = F.deletecustomer( Integer.parseInt(id.getText()) );
        if(r == 1) JOptionPane.showMessageDialog(null,"Customer has been deleted!","Success",JOptionPane.INFORMATION_MESSAGE);
